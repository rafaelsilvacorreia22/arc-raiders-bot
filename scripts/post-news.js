...
const APPID = 1808500; // ARC Raiders na Steam
...
async function main() {
  ...
  // so posts oficiais do desenvolvedor (Embark Studios) na propria pagina Steam da
  // comunidade, sem misturar materia de imprensa/fansite (PlayGround.ru, etc.)
